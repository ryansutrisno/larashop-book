...
<a href="{{route('users.create')}}" class="btn btn-info"><span class="oi oi-plus"></span> Create User</a>
	</div>
</div>
<br>
<hr class="my-3">
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="{{route('users.show', [$user->id])}}" class="btn btn-success btn-sm"><span title="Show Detail" class="oi oi-eye"></span></a>
				<a class="btn btn-warning text-white btn-sm" href="{{route('users.edit', [$user->id])}}"><span title="Edit" class="oi oi-pencil"></span></a>
