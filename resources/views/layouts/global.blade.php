...
<body>
	<nav class="navbar navbar-expand p-0">
		<a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="/home"><span class="oi oi-cart"></span> Larashop </a>
	...
	<div style="min-height: 100%" class="flex-row d-flex align-itemsstretch m-0">
		<div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
			...
			<input class="border-dark form-control d-block d-md-none mb-4" type="text" placeholder="Search" aria-label="Search" />
				<li><a href="/home"><span class="oi oi-dashboard"></span> Dashboard</a></li>
				...
				<li><a href="{{route('orders.index')}}"><span class="oi oi-spreadsheet"></span> Manage Orders</a></li>
		...
		<span class="oi oi-wrench"></span> Setting
		</div>
	</div>
