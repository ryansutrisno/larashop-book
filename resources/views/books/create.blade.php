			...
			@csrf
				...
				<label for="Price">Price</label> <br>
					<input value="{{old('price')}}" type="number" class="form-control {{$errors->first('price') ? "is-invalid" : ""}} " name="price" id="price" placeholder="Book price">
						...
						<br>
						<button class="btn btn-info" name="save_action" value="PUBLISH"><span class="oi oi-check"></span> Publish</button>
						<button class="btn btn-dark" name="save_action" value="DRAFT"><span class="oi oi-folder"></span> Save as Draft</button>
			</form>
		</div>
	</div>
@endsection
